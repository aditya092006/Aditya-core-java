...
class ImplementOddThread implements Runnable
{
	Prints target;
	Thread t;
...
class ImplementEvenThread implements Runnable
{
	Prints target;
	Thread t;
...
class ImplementPrimeThread implements Runnable
{
	Prints target;
	Thread t;
...
class ImplementFibonacciThread implements Runnable
{
	Prints target;
	Thread t;
